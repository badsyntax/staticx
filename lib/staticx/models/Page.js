...
var PageModel = module.exports = function(data) {
  ...
  this.setGetter('slug', this.getSlug.bind(this), data);
  this.setGetter('url', this.getUrl.bind(this), data);
  this.setGetter('metadata', this.getFormattedMetadata.bind(this), data);
  this.setGetter('filePath', this.getFilePath.bind(this), data);
  if (data && data['filePath'] !== undefined) {
    data['fileName'] = path.basename(data['filePath']);
  }
  this.setGetter('fileName', this.getFileName.bind(this), data);
...
PageModel.prototype.setGetter = function(property, method, data) {
  if (!data || data[property] === undefined) {
    this.__defineGetter__(property, method);
  }
};
