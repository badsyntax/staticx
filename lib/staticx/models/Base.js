...
/**
 * Thoughts:
 * I don't think the model should inherit from the file store.
 * save, delete, update etc methods should decorate the file store methods.
 */
...
var BaseModel = module.exports = function(data, config) {
  // FileStore.apply(this, arguments);
