...
ViewModel.prototype.renderSync = function() {
  ...
  Object.keys(this).forEach(function(prop) {
    if (this[prop] instanceof ViewModel) {
      this[prop] = this[prop].renderSync();
    }
  }.bind(this));

  return templateCompiler.compilePathSync(this.viewPath, this);
};
 ...
 * @param  {Function} done     Callback function.
 */
ViewModel.prototype.save = function(fileName, filePath, done) {
...
handlebars.VM.invokePartial = function(partial, name, context, helpers, partials, data) {
  ...
  if (partial === undefined && context.viewPath !== undefined) {
    ...
    var vmData = _.extend({}, context);
    delete vmData['viewPath'];

    cache.partials[name] = ViewModel.factory(name, destination, vmData).renderSync();
